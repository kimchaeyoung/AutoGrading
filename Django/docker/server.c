...
//			printf("respository passed to docker client\n") ;
		...
		if(atoi(msg) == 4) {
			system("docker cp ./input_output/input.txt docker:.") ;
//			printf("inputfile passed to docker client\n") ;
			send_message(new_socket, "5") ;
		}

		if(atoi(msg) == 6) {
			system("docker cp docker:./studentoutput.txt ./input_output");
//			printf("get student's output file\n") ;
			...
			int buff = 100 ;
                        ...
                        fp1 = fopen("./input_output/output.txt", "rt");
                        fp2 = fopen("./input_output/studentoutput.txt", "rt");
